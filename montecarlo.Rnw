...
# lista de funciones con pruebas no paramétricas para evaluar normalidad
funciones <- list(
...
# pasar pruebas de normalidad no paramétrica
...
% # <<child='secciones/10_marco_teorico.Rnw'>>=
% # 
% # @

 

% # <<motor, child='secciones/20_motor.Rnw'>>=
% # 
% # @

% # <<mandrell, child='secciones/30_mandrell.Rnw'>>=
% # 
% # @


<<producto, child='secciones/40_producto.Rnw'>>=

@


<<bib, child='secciones/50_bibliografia.Rnw'>>=

@

<<apendice, child='secciones/60_apendice.Rnw'>>=

@

<<figuras, child='secciones/70_figuras.Rnw'>>=

@

<<tablas, child='secciones/80_tablas.Rnw'>>=
